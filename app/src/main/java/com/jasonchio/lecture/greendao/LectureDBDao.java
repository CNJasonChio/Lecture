...
/** 
 * DAO for table "LECTURE_DB".
*/
public class LectureDBDao extends AbstractDao<LectureDB, Long> {

    public static final String TABLENAME = "LECTURE_DB";

    /**
     * Properties of entity LectureDB.<br/>
    ...
    public LectureDBDao(DaoConfig config) {
        super(config);
    }
    
    public LectureDBDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LECTURE_DB\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LECTURE_DB\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, LectureDB entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, LectureDB entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getLectureId());
    ...
    @Override
    public LectureDB readEntity(Cursor cursor, int offset) {
        LectureDB entity = new LectureDB( //
    ...
    @Override
    public void readEntity(Cursor cursor, LectureDB entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(LectureDB entity, long rowId) {
        entity.setLectureId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(LectureDB entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(LectureDB entity) {
