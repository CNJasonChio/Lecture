package com.jasonchio.lecture.util.searchview;
...
SearchView extends LinearLayout {
    ...
    private ImageView searchImage;// 搜索按键
    ...
    // 回调接口
    private ICallBack mCallBack;// 键盘搜索按键回调接口
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        // 搜索框高度
        searchBlockHeight = typedArray.getInteger(R.styleable.Search_View_searchBlockHeight, 180);

        // 搜索框颜色
        int defaultColor2 = context.getResources().getColor(R.color.colorDefault); // 默认颜色 = 灰色
    ...
    private void initView(){
       ...
       /* LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) search_block.getLayoutParams();
        ...
        // 7.搜索按钮
        searchImage =(ImageView) findViewById(R.id.search_search_image);
    }
